...
<template>
  <div>
    ...
    >
      ...
      >
        <div
          class="bg-purple-600 text-white px-4 py-2 rounded-xl mt-8 w-40 md:w-auto shadow-lg shadow-black flex items-center justify-center hover:transform hover:transform-ease-in-out hover:scale-105 cursor-pointer"
          @click="$router.push('/about')"
        >
          <i class="bi bi-person-lines-fill text-lg mr-2"></i>
          <p class="font-bold text-sm sm:text-base text-white">
            About<span class="hidden md:inline"> Me</span>
          </p>
        </div>
        <div
          class="bg-purple-600 text-white px-4 py-2 rounded-xl mt-8 w-40 md:w-auto shadow-lg shadow-black flex items-center justify-center hover:transform hover:transform-ease-in-out hover:scale-105 cursor-pointer"
        ...
        >
          ...
          <p class="font-bold text-sm sm:text-base text-white">
            Contact<span class="hidden md:inline"> Me</span>
          </p>
        </div>
      </div>
      <div class="mt-8 sm:mt-16 w-min mx-auto">
        <ContactLink />
      </div>
    </div>
    ...
    <div class="hidden lg:block">
      ...
      <p
        class="absolute top-1/4 left-0 transform rotate-90 text-3xl text-purple-500 font-bold font-ubuntu"
      >
        Jatin Bhardwaj
      </p>
